...
export const STAGES = [
  ...
  },
  {
    ...
    firstReward: { quartz: 280, bling: 120, plate: 2, core: 2, controlCore: 1, template1: 1 },
  ...
  },
  {
    ...
    firstReward: { quartz: 190, bling: 360, plate: 3, dust: 1, tradeSeal: 1, template2: 1 },
    repeatReward: { quartz: 82, bling: 175, plate: 1, tradeSeal: 1, template1: 1 },
    farmGoal: "무역 집행 인장",
  ...
  },
  {
    ...
    firstReward: { quartz: 520, bling: 330, plate: 6, key: 2, dust: 2, aquaCore: 1, template3: 1 },
    repeatReward: { quartz: 180, bling: 150, plate: 2, key: 1, aquaCore: 1, template2: 1 },
    farmGoal: "오염 수핵 재료",
    unlocks: { stages: [] },
  },
];
